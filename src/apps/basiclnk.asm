;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
; The BASICLNK app.
; This is the Snowdrop OS BASIC linker, used to create standalone Snowdrop OS
; executable applications from BASIC source code.
;
...
messageBadFileArgument:
	...
	db 'Example usage (produces MYPROG.APP):    BASICLNK [file=myprog.bas]', 13, 10
	db 0
...
start_interpreter:
	...
	mov ax, BASIC_GUI_FLAG_SHOW_STATUS_ON_ERROR | BASIC_GUI_FLAG_WAIT_KEY_ON_STATUS
	call basic_gui_entry_point	; interpret the inlined BASIC program text
