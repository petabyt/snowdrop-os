;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
; The Snowdrop OS boot loader 2.
;
; This version of the boot loader relies exclusively on single-sector reads
; via interrupt 13h.
; Its main responsibility is to load the Snowdrop OS kernel into memory from
; a FAT12 floppy disk, and then pass control to it.
;
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
; Begin BPB (BIOS Parameter Block) boilerplate
; values are specific to a 1.44Mb floppy disk
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;

pBlockOEM 					db "SNOWDROP"   ; 8 bytes for the OEM
	
; while there are many examples of boot loaders online, this one is suitable 
; to be applied to floppy disk images which 
; 	- will contain other files, but most importantly
;   - which are visible and accessible from DOS, as well as Windows XP

pBlockBytesPerSector:		dw 512
pBlockSectorsPerCluster:	db 1
pBlockReservedSectors:		dw 1	; our one boot sector
pBlockFATCount:				db 2
pBlockRootDirEntries:		dw 224
pBlockTotalSectors:			dw 2880
pBlockMedia:				db 0F0h
pBlockSectorsPerFAT:		dw 9
pBlockSectorsPerTrack:		dw 18
pBlockHeads:				dw 2

pBlockHiddenSectors:		dd 0 	; ignored in FAT12
pBlockTotalSectorsBig:		dd 0

bsDriveNumber:				db 0 	; ignored in FAT12
bsUnused:					db 0 	; ignored in FAT12

bsExtBootSignature:			db 29h
bsSerialNumber:				dd 538A538Ah
bsVolumeLabel:				db "SNOWDROP OS"
bsFileSystem:				db "FAT12   "

;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
; End BIOS parameter block boilerplate 
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
initialLoading:			db 13, 10, "Snowdrop OS loader is loading:", 13, 10
						db ".directory", 13, 10, 0
...
find_root_directory_entry:
	...
	mov bx, [pBlockRootDirEntries]	; this is the maximum number of 
